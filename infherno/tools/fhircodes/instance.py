...
from infherno.tools.fhircodes.utils import to_snowstorm
...
class GenericSnomedInstance:
    def __init__(self,
        ...
        if base_url is None:
            ...
            if self.base_url is None:
                raise ValueError("URL is not a Snowstorm instance.")
        ...
        self.branch = urllib.parse.quote_plus(self.branch) if branch_encode else self.branch
        self.headers = {
